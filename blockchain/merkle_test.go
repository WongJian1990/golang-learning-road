...
func TestNewMerkleTree(t *testing.T) {
	...
	// fmt.Println("n1: ", hex.EncodeToString(n1.Data))
	// fmt.Println("n2: ", hex.EncodeToString(n2.Data))
	// fmt.Println("n3: ", hex.EncodeToString(n3.Data))
	// fmt.Println("n4: ", hex.EncodeToString(n4.Data))
